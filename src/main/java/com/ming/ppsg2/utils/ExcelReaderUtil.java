...
public class ExcelReaderUtil {
    ...
    public static List<List<String>> readExcel(String path) {
        ...
        InputStream is = null;
        try {
            is = ExcelReaderUtil.class.getResourceAsStream(path);
            //获取工作薄
            Workbook wb = null;
     ...
     * @throws IOException
     */
    public static Workbook createExcel(List<List<String>> lists, String[] titles, String name) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        /*List<List<String>> lists = readExcel("/excel/data.xlsx");
        ...
        String s = "";
        for(GeneralsEnum.GeneralsCode code : GeneralsEnum.GeneralsCode.values()){
            s+=code.getName()+",";
